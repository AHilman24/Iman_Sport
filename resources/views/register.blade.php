...
<section class="bg-primary py-3 py-md-5 py-xl-4" style="width: 100vw">
  <div class="container">
    <div class="row gy-4 align-items-top">
      <div class="col-12 col-md-6 col-xl-7">
        <div class="d-flex justify-content-center text-bg-primary">
          <div class="col-12 col-xl-9 mt-5 py-5">
            <a href="/">
                <img class="img-fluid rounded mb-4" loading="lazy" src="../images/imas.png" width="245" height="80" alt="BootstrapBrain Logo">
              </a>
            <hr class="border-primary-subtle mb-4">
            <h2 class="h1 mb-4">Toko Online Olahraga Terlaris Di Galaksi Saat Ini</h2>
            <p class="lead mb-5">Belanja Kebutuhan Olahraga Kamu Disini</p>
            <div class="text-endx">
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-4 text-center">
                  <h3>Sign UP</h3>
                  <p>Do have Account? <a href="/login">Sign In</a></p>
                </div>
              </div>
            </div>
              ...
              <div class="row gy-3 overflow-hidden">
                <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="name" id="text" placeholder="name@example.com" required>
                      <label for="text" class="form-label">Nama Pengguna</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" name="no_hp" id="no_hp" placeholder="name@example.com" required>
                      <label for="no_hp" class="form-label">No.HP</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="alamat" id="text" placeholder="name@example.com" required>
                      <label for="text" class="form-label">Alamat Pengguna</label>
                    </div>
                  </div>
                <div class="col-12">
                  <div class="form-floating mb-3">
