                                    ...
                                    <div id="owl-single-product">
                                        <div class="single-product-gallery-item" id="slide1">
                                            <a data-lightbox="image-1" data-title="Gallery"
                                                href="tmpt/images/products/p8.jpg">
                                                <img class="img-responsive" alt="" src="{{ asset('storage/foto/'.$produk->foto) }}"
                                                    data-echo="tmpt/images/products/p8.jpg" />
                                            </a>
                                        </div>
                                            ...
                                            <div class="item">
                                                <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                    ...
                                                    <img class="img-responsive" width="85" alt=""
                                                        src="tmpt/images/blank.gif"
                                                        data-echo="tmpt/images/products/p17.jpg" />
                                                </a>
                                            </div>
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="stock-container info-container m-t-10">
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <div class="stock-box">
                                                    <span class="label">Stok Tersisa : </span>
                                                </div>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span class="value">{{ $produk->stok }}</span>
                                                </div>
                                            </div>
                                        </div><!-- /.row -->
                                    </div><!-- /.stock-container -->
                                    ...
                                    <div class="quantity-container info-container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                {{-- <a href="/cart/{{ $produk->id }}" class="btn btn-primary"><i
                                                        class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a> --}}
                                                        <form action="/cart/{{ $produk->id }}"
                                                            method="post">
                                                            @csrf
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="detail.html"><img src="tmpt/images/products/p1.jpg"
                                                        alt=""></a>
                                            </div><!-- /.image -->
